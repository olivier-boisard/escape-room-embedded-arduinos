class BoardDriver {
  public:
    BoardDriver(const function<size_t(byte inputBuffer[], size_t maxSize)>& readByteArray, const ByteArrayWriter& byteArrayWriter)
  ...
  private:
    function<size_t(byte inputBuffer[], size_t maxSize)> readByteArray;
